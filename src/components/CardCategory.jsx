...
function CardCategoria({ titulo, bgColor, spanCols, spanRows, onClick }) {
  return (
    <div
    ...
    >
      ...
      <button className="self-end mt-auto px-1 py-1 bg-black text-D_Gray text-sm rounded hover:text-primaryColor transition-colors" onClick={onClick}>
